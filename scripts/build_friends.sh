...
cp ../Friends/Friends.msbt romfs/message/EU_English/friend_msbt_LZ.bin
cp ../Friends/Hud.msbt romfs/message_hud/EU_English/hud_msbt_LZ.bin
./../tools/3dstool -zf romfs/message/EU_English/friend_msbt_LZ.bin --compress-type lz
