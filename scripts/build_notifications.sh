...
cp ../Notifications/Notifications.msbt romfs/message/EU_English/newslist_msbt_LZ.bin
cp ../Notifications/Hud.msbt romfs/message_hud/EU_English/hud_msbt_LZ.bin
./../tools/3dstool -zf romfs/message/EU_English/newslist_msbt_LZ.bin --compress-type lz
./../tools/3dstool -zf romfs/message_hud/EU_English/hud_msbt_LZ.bin --compress-type lz
